				...
				for train_step in range(self.args.train_steps):
					...
					if self.args.with_comm:
						for agent_id in range(self.args.n_agents):
							msgs_i, msgs_i_next = self.list_agents[agent_id].get_msgs_for_train(mini_batch, train_steps, agent_id)
							all_msgs.append(msgs_i)
							all_msgs_next.append(msgs_i_next)

					for agent_id in range(self.args.n_agents):
						self.list_agents[agent_id].train(mini_batch, train_steps, agent_id, all_msgs=all_msgs, all_msgs_next=all_msgs_next)
