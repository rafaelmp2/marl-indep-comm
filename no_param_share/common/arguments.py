...
def common_args():
	...
	parser.add_argument('--with_comm', type=bool, default=False, help='whether to use communication')
	...
	parser.add_argument('--rnn_hidden_dim', type=int, default=64, help='which rnn hidden dim')
